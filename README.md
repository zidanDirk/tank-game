...
Three.js 3D 俯视角「坦克大战」核心玩法原型。全部模型由程序化几何体组装，没有图片、模型下载或付费服务依赖。战役包含 3 个连续关卡，通关后保留分数进入下一关，失败只重试当前关。
...
- 第 1 关「前线阵地」：训练布局，砖墙形成六条可预判的进攻走廊。敌军以轻型为主，4 辆同时在场，间隔 4.5 秒。
- 第 2 关「交叉火力」：横纵交叉水域切断直线，中央钢墙迫使玩家换线。15 辆混编敌军，最多 5 辆同时在场，移动速度提升 8%，射击间隔缩短 10%。
...
这是单人三关核心原型：没有联网对战、存档、道具升级或战役编辑器；音效为本地合成。技术参考：[Three.js 官方安装文档](https://threejs.org/manual/en/installation.html)。
